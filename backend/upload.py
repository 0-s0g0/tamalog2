...
import os
from backend.inbody import detect_numbers  # 修正後: backendからinbodyをインポート
from backend.inbody import extract_largest_contour_region  # 修正後: backendからinbodyをインポート
